...
namespace EIMS.Migrations
{
    ...
    [Migration("20210806114242_TotalStudentsinEnrollment")]
    partial class TotalStudentsinEnrollment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.ExamEnrollment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 6, 11, 42, 42, 290, DateTimeKind.Utc).AddTicks(2187));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        ...
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 6, 11, 42, 42, 290, DateTimeKind.Utc).AddTicks(4044));
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.Examination", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 6, 12, 42, 42, 288, DateTimeKind.Local).AddTicks(8544));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 6, 12, 42, 42, 288, DateTimeKind.Local).AddTicks(6359));
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.ExaminationStudent", b =>
                {
                    b.Property<int>("ExaminationId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ExaminationId", "StudentId");
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.Inspector", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.InspectorLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.OfferedStudentExamSubject", b =>
                {
                    b.Property<int>("ExamId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ExamId", "StudentId", "SubjectId");
                    ...
                    b.ToTable("OfferedStudentExamSubjects");
                });
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 8, 6, 12, 42, 42, 286, DateTimeKind.Local).AddTicks(4897));
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.Examination", b =>
                {
                    b.HasOne("EIMS.Domain.Entities.Classes", "ExamClass")
                        .WithMany()
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.ExaminationStudent", b =>
                {
                    b.HasOne("EIMS.Domain.Entities.Examination", "EnrolledExamination")
                        .WithMany("ExaminationStudents")
                        .HasForeignKey("ExaminationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EIMS.Domain.Entities.Student", "EnrolledStudent")
                        .WithMany()
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.InspectorLog", b =>
                {
                    b.HasOne("EIMS.Domain.Entities.Inspector", "Inspector")
                        .WithMany()
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.OfferedStudentExamSubject", b =>
                {
                    ...
                    b.HasOne("EIMS.Domain.Entities.Student", "Student")
                        .WithMany("OfferedStudentExamSubjects")
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EIMS.Domain.Entities.Subject", "OfferedSubject")
                        .WithMany("OfferedExamStudents")
                        .HasForeignKey("SubjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
